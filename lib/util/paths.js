...
module.exports = {
  ...
  getTemplatesPath({ username, fileDataUrl }) {
    ...
    const file = fileDataUrl ? path.join(this.normalizeFileDataUrl(fileDataUrl), 'templates.json') : path.join(guidesDir, username, 'templates.json');
  ...
  getTemplatePath({ username, guideId, templateId, fileDataUrl }) {
    ...
    const file = fileDataUrl ? path.join(this.normalizeFileDataUrl(fileDataUrl), filename) : path.join(guidesDir, username, folderName, filename);
